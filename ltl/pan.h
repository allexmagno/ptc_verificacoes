...
#define _nstates4	21	/* justica */
#define minseq4	34
#define maxseq4	53
#define _endstate4	20

#define _nstates3	11	/* crit */
#define minseq3	24
#define maxseq3	33
#define _endstate3	10

#define _nstates2	8	/* p2 */
#define minseq2	17
#define maxseq2	23
#define _endstate2	7

#define _nstates1	8	/* p1 */
#define minseq1	10
#define maxseq1	16
#define _endstate1	7

#define _nstates0	11	/* Dijkstra */
#define minseq0	0
#define maxseq0	9
...
#define PDijkstra	((P0 *)_this)
typedef struct P0 { /* Dijkstra */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, count) - 1*sizeof(uchar))
